...
public class OBJLoader {
  ...
  //take in the .obj file, load it up, get all date and return it as a RawModel
  //that our game can render
  public static RawModel loadObjModel(String fileName, Loader loader) {
    ...
    List<Vector3f> normals = new ArrayList<Vector3f>();//for lightning
    List<Integer> indices = new ArrayList<Integer>();
    //how our loader needs data to be
